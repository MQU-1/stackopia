...
export const DESIGN_SYSTEM = {
  title: 'Stackopia Design System',
  description:
    'Dark-first visual language for an AI-powered financial coaching app. Lime-green primary, Syne display type, DM Sans body, card-boxed layouts.',
} as const;
