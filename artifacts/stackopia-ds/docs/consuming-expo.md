# Consuming Stackopia Design System in Expo apps

Read `artifacts/stackopia-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/stackopia-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/stackopia-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/stackopia-ds/lib/native-theme";
import { useColors } from "@workspace/stackopia-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/stackopia-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/stackopia-ds/components/native/badge";
import { Button } from "@workspace/stackopia-ds/components/native/button";
import { Card } from "@workspace/stackopia-ds/components/native/card";
```
...
Import and render
`@workspace/stackopia-ds/components/native/button`, then run Expo
