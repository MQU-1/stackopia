# Stackopia Design System design system
...
workspace package (`@workspace/stackopia-ds`): other artifacts depend
...
`@workspace/stackopia-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/stackopia-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/stackopia-ds` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/stackopia-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/stackopia-ds/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/stackopia-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/stackopia-ds/docs/migrating-expo.md`
