# Consuming Stackopia Design System in web apps

Read `artifacts/stackopia-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/stackopia-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/stackopia-ds/styles.css";
```
...
`node_modules/@workspace/stackopia-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/stackopia-ds/hooks/use-toast";
```
...
`@workspace/stackopia-ds/components/ui/button`. Run the app's typecheck
