# Migrating web UI to Stackopia Design System

Read `artifacts/stackopia-ds/docs/AGENTS.md` and
`artifacts/stackopia-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/stackopia-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/stackopia-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/stackopia-ds/hooks/use-toast`
